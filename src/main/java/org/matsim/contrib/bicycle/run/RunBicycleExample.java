...
public class RunBicycleExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 1) {
			...
			config.network().setInputFile("network_centerCobblestone.xml"); // Modify this
	...
	public static void fillConfigWithBicycleStandardValues(Config config) {
		...
		bicycleConfigGroup.addParam("marginalUtilityOfInfrastructure_m", "-0.0000");
		bicycleConfigGroup.addParam("marginalUtilityOfComfort_m", "-0.0000");
		bicycleConfigGroup.addParam("marginalUtilityOfGradient_m_100m", "-0.00");
		bicycleConfigGroup.addParam("betaCobblestone", "-1.72");
		//bicycleConfigGroup.addParam("betaCobblestoneAgeGroup2", "1.72");
		bicycleConfigGroup.addParam("betaCobblestoneAgeGroup2", "0.00");
		...
		bicycle.setMarginalUtilityOfDistance(-0.0000); // util/m
