...
import bicyclePopulationModifications.AssignPersonAttributes;
...
public class BicycleUtilityUtils {
	...
	public static double calculateLinkComfortDisutility (Link link, Leg leg, BicycleConfigGroup bicycleConfigGroup, Person person, double marginalUtilityOfComfort_m,
		...
		int ageGroupDummy1 = Integer.parseInt(person.getAttributes().getAttribute(AssignPersonAttributes.AGE_GROUP_DUMMY_1).toString());
		...
		//debug
		if(localPavementDummyCobblestone == 1 && ageGroupDummy2 == 1) {
